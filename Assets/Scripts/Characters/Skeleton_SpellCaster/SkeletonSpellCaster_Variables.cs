...
public class SkeletonSpellCaster_Variables : MonoBehaviour
{
    //-------------------------------------------------------------------------------------------------------------------------------VARIABLES FOR SKELETON SPELLCASTER

    public float spellCastDistance; //Distance in which skeleton starts spellcasting stuff
